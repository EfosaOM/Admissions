...
$sqls = "SELECT * FROM government_agency";
...
?>
<br>
<a href="newagency.php">Click here to add new government agency</a>
<br><br>
<a href="updateagency.php">Click here to update government agency record</a>
<br><br>
